...
import { exportToPDF } from "@/app/(back-office)/dashboard/reports/inventory/columns";
...
const loadJsPDF = () => import("jspdf").then(module => {
  ...
  async function previewData() {
    ...
    if (excelFile) {
      try {
        ...
        toast.error('Error loading Excel library');
      }
    }
  }
